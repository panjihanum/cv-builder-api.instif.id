...
const css = `
body { font-family: Arial, Helvetica, sans-serif; color: #1f2937; font-size: 10pt; line-height: 1.55; margin: 0; min-height: 100vh; padding: 44px 52px; }
header.header { border-bottom: 0.75pt solid #e5e7eb; padding-bottom: 10px; margin-bottom: 14px; }
header.header h1 { font-size: 20pt; font-weight: 700; color: #111827; margin: 0 0 2px; }
header.header .role { font-size: 9.5pt; font-weight: 600; color: #0d9488; margin: 0 0 4px; }
header.header .contact { font-size: 8.5pt; color: #6b7280; margin: 0; }
.section { margin-bottom: 12px; }
.section h2 { font-size: 9.5pt; font-weight: 700; text-transform: uppercase; letter-spacing: 2px; color: #0d9488; border-bottom: 0.75pt solid #0d9488; padding-bottom: 2px; margin: 0 0 6px; }
...
export function renderAtsPace(data: CvData): string {
