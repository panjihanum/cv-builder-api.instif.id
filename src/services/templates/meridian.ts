...
body { font-family: Helvetica, Arial, sans-serif; color: #1e293b; font-size: 9.5pt; line-height: 1.55; margin: 0; background: #ffffff; min-height: 100vh; }
.page { padding: 32px 40px; }
header { display: flex; align-items: center; gap: 18px; border-bottom: 1px solid #ccfbf1; padding-bottom: 20px; }
.photo { width: 82px; height: 82px; border-radius: 50%; object-fit: cover; border: 2px solid #99f6e4; flex-shrink: 0; }
header .info { flex: 1; }
h1 { font-size: 21pt; font-weight: 800; letter-spacing: -0.5px; color: #0f172a; margin: 0 0 2px; }
.role { margin: 0 0 8px; font-size: 9pt; font-weight: 600; color: #0d9488; }
.contact { display: flex; flex-wrap: wrap; gap: 5px 12px; font-size: 7.5pt; color: #64748b; }
...
.skill-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 5px 30px; }
.si { display: flex; align-items: center; gap: 6px; font-size: 8.5pt; color: #334155; }
